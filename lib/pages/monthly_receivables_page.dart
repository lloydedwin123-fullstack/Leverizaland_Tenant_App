                          ...
                          return Container(
                            ...
                            child: ListTile(
                              ...
                              leading: Container(
                                ...
                                child: Icon(Icons.priority_high, color: Theme.of(context).colorScheme.error, size: 18),
                              ),
                              title: Text(
                                tenantName,
                                style: TextStyle(
                              ...
                              subtitle: Padding(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    const SizedBox(width: 4),
                                    Text(dateStr, style: TextStyle(fontSize: 13, color: Theme.of(context).colorScheme.onSurface.withOpacity(0.8))),
                                  ],
                                ),
                              ),
                              trailing: Column(
